...
if closing_date >= dt.date(closing_year, 1, 1) and closing_date <= dt.date(closing_year, 7, 1):
...
print("Seller's tax responsibility: $%0.2f" % seller_portion)
print("Buyer's tax responsibility: $%0.2f" % buyer_portion)
